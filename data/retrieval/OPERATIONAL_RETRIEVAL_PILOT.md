...
|----|----------|----------|---------------------------|-----------------|
| **S1** | 2-character emotional loop | **A** `arkham_asylum_cell_intake` | e.g. `harley_quinn` as **cell_resident**, `magpie` as **new_arrival** | Voice/goals in retrieved vs noise; duplication vs grounding |
