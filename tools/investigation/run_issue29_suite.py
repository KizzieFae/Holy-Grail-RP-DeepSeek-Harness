...
SCENARIOS: list[tuple[str, str, int]] = [
    (
        ...
        str(DATA_DIR / "issue29_investigation_schedules/negotiation_harley_kizzie_ayame.json"),
        25,
    ),
    (
        "investigate_i29_transformation_persistence",
        str(DATA_DIR / "issue29_investigation_schedules/transformation_persistence.json"),
        25,
    ),
    (
        "investigate_i29_object_continuity",
        str(DATA_DIR / "issue29_investigation_schedules/object_continuity.json"),
        25,
    ),
    (
        "investigate_i29_instruction_retention",
        str(DATA_DIR / "issue29_investigation_schedules/instruction_retention.json"),
        25,
    ),
    (
        "investigate_i29_cross_scene_carry",
        str(DATA_DIR / "issue29_investigation_schedules/cross_scene_50.json"),
        50,
    ),
    (
        "investigate_i29_multi_thread_dialogue",
        str(DATA_DIR / "issue29_investigation_schedules/multi_thread.json"),
        25,
    ),
]
