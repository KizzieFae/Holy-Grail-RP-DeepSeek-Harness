...
| Scene start/end / template roles | `scene_start_bootstrap.py`, `app_state_continuity.py` (`restore_or_initialize_continuity_manager`), `scene_lifecycle_start.py`, `scene_lifecycle_actions.py`, `scene_template.py` |
