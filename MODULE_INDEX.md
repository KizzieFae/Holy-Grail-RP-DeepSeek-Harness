...
| `scene_pressures` lacks Librarian semantic overlay / stale overlay projected | `continuity_scene_pressure_projection.py`, `director_context_digests.py`, `character_context_projector.py`, `storyteller_orientation_context.py`, `continuity_librarian_issue_pressure.py` |
