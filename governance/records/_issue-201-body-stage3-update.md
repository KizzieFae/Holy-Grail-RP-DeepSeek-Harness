...
- Stage-2 synthesis SHA: `b391336` — `governance/records/issue-201-package-d-stage2-synthesis-2026-09-14.md`
- Packages A–C record: `governance/records/issue-201-packages-abc-investigation-2026-09-14.md`

## Execution snapshot

**Package D Stage 3 authorized — preamble decomposition (D-01a + D-01b) in progress (2026-09-14).**
...
| D0 baseline | Accepted (`issue201-d0-baseline-2026-09-14T07-46-14-584Z`) |
| Stage-2 tranche 1 (EXP-1/2/3) | Accepted |
| Stage-2 refinement + synthesis | Accepted (`b391336`) |
| Governance blind eval (Stage-2) | Locked, decoded, recorded |

**Stage-2 provisional classifications (Governance-accepted):**

- **EXP-1 / D-01:** Retain function; strong decomposition candidate (blind Δ overall −0.32 vs D0)
- **EXP-2 / D-06:** Strong combine/remove candidate; no demonstrated marginal QA value (blind Δ +0.12)
- **EXP-3 / D-03:** Conditional retain / complexity-tier candidate (scenario-dependent)

**Stage 3 objective:** Execute D-01b (Storyteller-only bypass) and D-01a (Plot-only bypass) to decompose EXP-1 quality signal. Reuse D0 and D-01 combined evidence; fresh blind packet for 2×2 matrix.

**Explicit prohibitions:** no production redesign/remediation; no preamble production tiering; no D-10/Librarian/PVR/compact-topology ablations; no Packages E–G synthesis unless separately authorized.
...
Repeat-F06 audit; Package D causal ablation tranches; blind semantic evaluation records under `governance/records/issue201-stage2-*`.
...
Complete Package D Stage 3 preamble decomposition (D-01a + D-01b); prepare fresh blind packet; await Governance blind scoring before decode. Remain at `investigating`. No production redesign.
