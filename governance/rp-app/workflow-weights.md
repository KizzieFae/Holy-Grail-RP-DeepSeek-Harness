...
- **`standard`** and **`light`** consensus and bootstrap paths documented in **`issue-tracking-workflow.md` §B.0.1** and **`governance/policies/cursor-workflow-layer.md`** apply when **effective** weight is **`standard`** or **`light`** respectively.
...
- `governance/policies/gpt-workflow-instruction-set.md` — orchestration AI obligations (weight assignment, escalation, prompts).
