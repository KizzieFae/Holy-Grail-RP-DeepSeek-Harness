...
- **Evidence** — execution evidence; Character: `list_execution_evidence.py --dimension R11`; Director/Narrator QA: `--chain director|narrator --round <id> --summary`; Narrator F1 fidelity retry drill-down: [audit-workflows.md](./audit-workflows.md) → Narrator F1 fidelity retry; participation-direct: `--chain participation --round <id>`
