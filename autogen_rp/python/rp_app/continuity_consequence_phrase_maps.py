"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_consequence_phrase_maps.py."""
...
_MOD_NAME = 'continuity_consequence_phrase_maps'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_consequence_phrase_maps.py'
