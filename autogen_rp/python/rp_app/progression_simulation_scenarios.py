"""Legacy V1 import shim — implementation in v2/domain/modules/progression_simulation_scenarios.py."""
...
_MOD_NAME = 'progression_simulation_scenarios'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'progression_simulation_scenarios.py'
