"""Legacy V1 import shim — implementation in v2/domain/modules/character_move_ingress.py."""
...
_MOD_NAME = 'character_move_ingress'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'character_move_ingress.py'
