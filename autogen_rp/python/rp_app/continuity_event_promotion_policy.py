"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_event_promotion_policy.py."""
...
_MOD_NAME = 'continuity_event_promotion_policy'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_event_promotion_policy.py'
