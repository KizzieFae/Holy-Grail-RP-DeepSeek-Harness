"""Legacy V1 import shim — implementation in v2/domain/modules/cross_session_memory_policy.py."""
...
_MOD_NAME = 'cross_session_memory_policy'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'cross_session_memory_policy.py'
