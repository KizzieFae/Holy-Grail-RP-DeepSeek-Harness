"""Legacy V1 import shim — implementation in v2/domain/modules/response_validation_parsing.py."""
...
_MOD_NAME = 'response_validation_parsing'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'response_validation_parsing.py'
