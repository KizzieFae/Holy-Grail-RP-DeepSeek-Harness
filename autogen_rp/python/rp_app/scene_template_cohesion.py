"""Legacy V1 import shim — implementation in v2/domain/modules/scene_template_cohesion.py."""
...
_MOD_NAME = 'scene_template_cohesion'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'scene_template_cohesion.py'
