"""Legacy V1 import shim — implementation in v2/domain/modules/resolved_outcome_medical_suppressant_formulation.py."""
...
_MOD_NAME = 'resolved_outcome_medical_suppressant_formulation'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'resolved_outcome_medical_suppressant_formulation.py'
