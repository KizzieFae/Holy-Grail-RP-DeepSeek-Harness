"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_setup_seam_v77.py."""
...
_MOD_NAME = 'continuity_setup_seam_v77'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_setup_seam_v77.py'
