"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_mutation_pipeline_validate.py."""
...
_MOD_NAME = 'continuity_mutation_pipeline_validate'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_mutation_pipeline_validate.py'
