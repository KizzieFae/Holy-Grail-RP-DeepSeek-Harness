"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_issue_helpers.py."""
...
_MOD_NAME = 'continuity_issue_helpers'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_issue_helpers.py'
