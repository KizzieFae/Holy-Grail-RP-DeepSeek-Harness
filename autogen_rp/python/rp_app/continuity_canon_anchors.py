"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_canon_anchors.py."""
...
_MOD_NAME = 'continuity_canon_anchors'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_canon_anchors.py'
