"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_consequence_classifier_detect_scene_dynamics.py."""
...
_MOD_NAME = 'continuity_consequence_classifier_detect_scene_dynamics'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_consequence_classifier_detect_scene_dynamics.py'
