"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_state_resolved_outcome.py."""
...
_MOD_NAME = 'continuity_state_resolved_outcome'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_state_resolved_outcome.py'
