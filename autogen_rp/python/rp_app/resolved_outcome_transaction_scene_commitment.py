"""Legacy V1 import shim — implementation in v2/domain/modules/resolved_outcome_transaction_scene_commitment.py."""
...
_MOD_NAME = 'resolved_outcome_transaction_scene_commitment'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'resolved_outcome_transaction_scene_commitment.py'
