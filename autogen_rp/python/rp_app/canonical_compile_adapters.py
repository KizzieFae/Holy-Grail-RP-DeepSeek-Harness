"""Legacy V1 import shim — implementation in v2/domain/modules/canonical_compile_adapters.py."""
...
_MOD_NAME = 'canonical_compile_adapters'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'canonical_compile_adapters.py'
