"""Legacy V1 import shim — implementation in v2/domain/modules/user_presence_signals.py."""
...
_MOD_NAME = 'user_presence_signals'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'user_presence_signals.py'
