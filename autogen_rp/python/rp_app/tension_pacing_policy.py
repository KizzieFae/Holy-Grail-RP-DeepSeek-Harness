"""Legacy V1 import shim — implementation in v2/domain/modules/tension_pacing_policy.py."""
...
_MOD_NAME = 'tension_pacing_policy'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'tension_pacing_policy.py'
