"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_process_turn_orchestration.py."""
...
_MOD_NAME = 'continuity_process_turn_orchestration'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_process_turn_orchestration.py'
