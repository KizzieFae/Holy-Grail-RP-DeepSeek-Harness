"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_manager_event_surface.py."""
...
_MOD_NAME = 'continuity_manager_event_surface'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_manager_event_surface.py'
