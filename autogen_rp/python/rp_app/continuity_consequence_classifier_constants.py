"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_consequence_classifier_constants.py."""
...
_MOD_NAME = 'continuity_consequence_classifier_constants'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_consequence_classifier_constants.py'
