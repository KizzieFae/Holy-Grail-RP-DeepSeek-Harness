"""Legacy V1 import shim — implementation in v2/domain/modules/issue240_semantic_evaluation.py."""
...
_MOD_NAME = 'issue240_semantic_evaluation'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'issue240_semantic_evaluation.py'
