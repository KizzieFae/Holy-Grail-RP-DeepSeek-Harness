"""Legacy V1 import shim — implementation in v2/domain/modules/continuity_audit_origin.py."""
...
_MOD_NAME = 'continuity_audit_origin'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'continuity_audit_origin.py'
