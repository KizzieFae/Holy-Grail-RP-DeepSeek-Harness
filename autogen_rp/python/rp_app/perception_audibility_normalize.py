"""Legacy V1 import shim — implementation in v2/domain/modules/perception_audibility_normalize.py."""
...
_MOD_NAME = 'perception_audibility_normalize'
_MODULES = Path(__file__).resolve().parents[3] / "v2" / "domain" / "modules"
_IMPL = _MODULES / 'perception_audibility_normalize.py'
