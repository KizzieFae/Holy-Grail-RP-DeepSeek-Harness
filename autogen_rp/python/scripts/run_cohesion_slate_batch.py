...
RUNS = [
    (
        ...
        12,
        "data/issue227/cohesion_slate/household_probe_schedule_v1.json",
    ),
    (
        "household_flex",
    ...
    (
        ...
        14,
        "data/issue227/cohesion_slate/arkham_probe_schedule_v1.json",
    ),
    (
        "arkham_flex",
    ...
    (
        ...
        16,
        "data/issue227/cohesion_slate/apartment_probe_schedule_v1.json",
    ),
    (
        "apartment_flex",
