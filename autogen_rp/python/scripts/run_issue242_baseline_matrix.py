...
MATRIX_V1_NEXT7 = [
    ("R1a", "cert_i234_proposal_accept_off_focal", 6, "data/issue240/cert_i234_reinforced_overlay.json"),
    ("R1b", "cert_i234_proposal_accept_off_focal", 6, "data/issue240/cert_i234_reinforced_overlay.json"),
    ("R2a", "emotional_loop_2char", 12, "data/issue240/emotional_loop_2char_actor_targeted_overlay.json"),
    ("R2b", "emotional_loop_2char", 12, "data/issue240/emotional_loop_2char_actor_targeted_overlay.json"),
    ("R2c", "emotional_loop_2char", 12, "data/issue240/emotional_loop_2char_actor_targeted_overlay.json"),
    ("E1", "conflict_3char", 12, None),
    ("E2", "audit_i225_willow_must_remain_v2_offstage_cycles", 12, "data/issue240/audit_i225_willow_actor_targeted_overlay.json"),
    ("E3", "long_session", 12, None),
]

MATRIX_PRODUCTION = [
    ("T3a", "cert_i234_proposal_accept_off_focal", 6, "data/issue240/cert_i234_reinforced_overlay.json"),
    ("T3b", "emotional_loop_2char", 12, "data/issue240/emotional_loop_2char_actor_targeted_overlay.json"),
]
...
def _extract_sessions(session_ids: list[str], scenario_hint: str | None = None) -> None:
    ...
    cmd = [
        sys.executable,
        str(_PY / "scripts" / "_issue240_extract_prompts.py"),
        *session_ids,
        "--out-dir",
...
def main() -> int:
    ...
    rollup_cmd = [
        sys.executable,
        str(_PY / "scripts" / "_issue242_topology_rollup.py"),
        "--manifest-dir",
        str(_PROMPT_OUT.relative_to(_PY)).replace("\\", "/"),
        "--out",
