...
def main() -> int:
    ...
    ap.add_argument("--manifest", default="data/issue240/final_viability_matrix_v1.json")
    ap.add_argument("--out", default="data/issue240/adjudication_corpus_final_viability_v1.json")
    args = ap.parse_args()
