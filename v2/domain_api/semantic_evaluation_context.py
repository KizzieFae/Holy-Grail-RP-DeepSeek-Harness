    ...
    contributions.append(
        PromptContribution(
            ...
            content=(
                ...
                "Objective regression of established Player completion/state (candidate asserts "
                "authoritative completed Player action or positional state did not occur, remains "
                "unperformed, or was undone without reversal authority) → R16 hard with "
                "guardrail:player_action_completion; Character ignorance, commands from "
                "incomplete perception, deliberate deception/manipulation, and distinct "
                "subsequent requirements are not objective regression. "
