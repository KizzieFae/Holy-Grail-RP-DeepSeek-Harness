...
from domain.character_cards import make_agent_identifier  # noqa: E402
from domain.paths import sessions_data_dir  # noqa: E402
from cross_session_memory_policy import (  # noqa: E402
    append_load_item,
...
class SessionManager:
    ...
    def __init__(self, sessions_dir: str | Path = None) -> None:
        ...
        if sessions_dir is None:
            self.sessions_dir = sessions_data_dir()
        else:
