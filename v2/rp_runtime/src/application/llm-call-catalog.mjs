...
export const PRIMARY_RUNTIME_CATALOG = Object.freeze([
  ...
  entry('librarian_proposal', 'librarian_proposal', [], 'librarian', 'librarian/proposal', 'Post-commit librarian semantic proposal generation', 'lib/librarian-proposal-substrate.mjs', 'runLibrarianProposalGeneration', 'After character commit (parallel with narrator presentation)', 'kind_override', 'storyteller', 'librarian_proposal'),
  entry('librarian_proposal_contract_correction', 'librarian_proposal_contract_correction', [], 'librarian', 'librarian/proposal', 'Contract correction retry for librarian proposal', 'lib/contract-correction-substrate.mjs', 'runInferenceWithContractCorrection', 'Primary librarian proposal structural parse failure (max 1)', 'kind_override', 'storyteller', 'librarian_proposal_contract_correction'),
