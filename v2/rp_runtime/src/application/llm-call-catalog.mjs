...
export const PRIMARY_RUNTIME_CATALOG = Object.freeze([
  ...
  entry('librarian_mediation_contract_correction', 'librarian_mediation_contract_correction', [], 'librarian', 'librarian/mediation', 'Contract correction for S2a librarian mediation', 'lib/contract-correction-substrate.mjs', 'runInferenceWithContractCorrection', 'Primary librarian mediation structural parse failure (max 1)', 'kind_override', 'librarian', 'librarian_mediation_contract_correction'),
  ...
  entry('player_uniform_eligibility_verification', 'player_uniform_eligibility_verification', [], 'player_uniform_eligibility_verification', 'player-turn/pvr', 'Adversarial uniform-eligibility verification after affirmative triage', 'plugins/hg-phase-executors/player-uniform-eligibility-verification.mjs', 'runPlayerUniformEligibilityVerification', 'Only after affirmative player visibility triage', 'kind_override', 'character', 'player_uniform_eligibility_verification', null, '64-token kind ceiling (#197); reasoning off'),
