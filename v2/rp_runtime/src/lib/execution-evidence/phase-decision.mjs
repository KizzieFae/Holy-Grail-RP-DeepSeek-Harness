...
export function narratorDecisionPatch({
  ...
  candidatePresentationText = null,
  fidelityCorrection = null,
  terminalDisposition = null,
  semanticQa = null,
  residualSoftConcerns = null,
  ...
  const patch = {
    decision: {
      ...
      candidate_presentation_text: candidatePresentationText ?? null,
      ...
      fidelity_correction: fidelityCorrection ?? null,
