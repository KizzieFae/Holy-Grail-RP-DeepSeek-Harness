...
| If you need… | Read |
|--------------|------|
| Product goals, layers, non-goals | [Holy Grail PRD.md](./Holy%20Grail%20PRD.md) |
...
- **`autogen_rp/docs/`** — Shared technical docs (repo map, testing, audit workflows, [rp-data layout](./autogen_rp/docs/rp-data-layout.md)).
