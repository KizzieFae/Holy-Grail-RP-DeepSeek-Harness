...
- **Location (V2):** Domain library `v2/domain/modules/`; Domain Host `v2/domain_api/`; neutral-domain tests `v2/domain/tests/`; product data `data/` (`HG_DATA_DIR`). V1 orchestration under `autogen_rp/python/rp_app/` was removed M12.4.
...
Details: `autogen_rp/python/rp_app/ARCHITECTURE.md`, `docs/architecture.md`.
