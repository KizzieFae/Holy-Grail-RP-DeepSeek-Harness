...
- **Phase 0.5 packet seam (shadow):** `runtime_packets.py` — read-only projections and optional env-gated structured compare in `app_turn_prompting`; no second authority ([autogen_rp/docs/architecture.md](./autogen_rp/docs/architecture.md)).
