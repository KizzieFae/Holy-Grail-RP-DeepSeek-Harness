...
- **Workflow weights:** Governance AI **assigns** workflow weight before substantive Issue work (per the **authoritative Governance AI instruction set**, supplied separately); implementation AI (**Cursor**) inherits **assigned**/**effective** weight and must not reinterpret rigor independently. Canonical **`light` / `standard` / `full`** and escalation triggers — **`governance/sources/workflow-weights.md`** only. **Routine filing assigned default:** **`standard`**. Weight-aware bootstrap + anchor-first retrieval — **`governance/execution/cursor-workflow-layer.md`**; authoritative profile read lists — **`docs/issue-bootstrap-profiles.md`**. Consensus recording shapes — **`governance/sources/issue-tracking-workflow.md` §B.0.1**.
...
- **Governance-AI upload corpus:** `governance/sources/` — Holy-Grail **project-specific standing sources** for Governance AI (six files; see `governance/README.md`). Upload **after** supplying the authoritative universal Governance AI instruction set (maintained outside this repository). **Not** uploaded by humans for normal Governance operation: this file (`AGENTS.md`).
...
- **Narrow exception — active program disposition map (#214):** The accepted next-generation migration disposition map [`governance/records/issue-214-child-a-disposition-map-2026-09-18.md`](./governance/records/issue-214-child-a-disposition-map-2026-09-18.md) is **current migration-program authority** for work under **#213** / children **#214**–**#223**, **routed** via [governance/sources/architecture-overview.md](./governance/sources/architecture-overview.md) (standing anchors) and [docs/issue-bootstrap-profiles.md](./docs/issue-bootstrap-profiles.md) (scoped mandatory read). This does **not** reclassify `governance/records/` generally as Governance upload corpus or universal current authority.
